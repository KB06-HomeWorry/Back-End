import{_ as H,d as u,h as P,x as V,i as d,c as g,e as p,a as e,q as x,S as q,t as c,F as w,y as S,g as O,o as r,n as j,f as M,D as $,j as z}from"./index-DDyrP9F_.js";import{B as A,A as E,H as U,R as G}from"./ReviewBox-s9cV2sxP.js";import{b as J,a as K}from"./star_outline-Cw4kId92.js";import{p as Q,a as W,b as X}from"./sample_profile3-DzvHCZTU.js";const Y=["title"],Z=["src"],ee={class:"agency-profile-wrap"},ae={class:"profile-row"},te=["src"],se={class:"profile-info"},oe={class:"agency-name titleBold16px"},ne={class:"hashtags"},ie={class:"agency-info-table"},ce={class:"bodyLight12px"},re={class:"bodyLight12px"},le={class:"bodyLight12px"},de={class:"bodyLight12px"},ue={class:"agency-description"},ge={class:"desc-content bodyLight12px"},pe={class:"agency-btn-row"},fe={key:0,class:"review-list-wrap"},he={key:1,class:"bodyLight12px",style:{"text-align":"center",color:"var(--color-mediumgray)",margin:"24px 0"}},me={__name:"AgencyDetail",setup(_e){const v=[Q,W,X],B=u(v[Math.floor(Math.random()*v.length)]),y=O(),b=P(),n=b.query.agencyId||b.params.agencyId||"1",f=localStorage.getItem("user-token"),a=u({office_name:"",profileUrl:"",hashtags:[],agent_name:"",license_number:"",address:"",phone:"",description:""}),h=u({finalTrustScore:"",averageMetricScores:{listing_accuracy_score:"",cost_transparency_score:"",professionalism_score:"",accountability_score:""}}),m=u([]),i=u(!1);async function I(){try{const s=await d.get(`/api/agent/${f}/isFavorite/${n}`);i.value=s.data}catch{i.value=!1}}async function L(){try{i.value?(await d.delete(`/api/agent/${f}/favorite/${n}`),i.value=!1):(await d.get(`/api/agent/${f}/favorite/${n}`),i.value=!0)}catch{alert("북마크 처리 중 오류가 발생했습니다.")}}V(async()=>{try{const s=await d.get(`http://localhost:8080/api/agent/${n}`);if(a.value={...a.value,office_name:s.data.officeName,agent_name:s.data.agentName,license_number:s.data.licenseNumber,address:s.data.address,phone:s.data.phone,description:s.data.description,hastags:s.data.hashtags||[]},!a.value.description||a.value.description.trim()===""){const l=[`🏢 안녕하세요, 젊은 감각을 가진 공인중개사입니다!
